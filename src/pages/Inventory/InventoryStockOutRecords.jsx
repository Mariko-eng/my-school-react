...
const InventoryStockOutRecords = () => {
  ...
  const getProducts = () => {
    const url = "http://127.0.0.1:8000/store/outward-list/";
    ...
    <div>
      <div>
        ...
        >
          ...
          <Breadcrumb.Item>Outward Stock Records</Breadcrumb.Item>
        </Breadcrumb>
      </div>
      <div>
        <Breadcrumb>
...
export default InventoryStockOutRecords;
